...
__export(index_exports, {
    createGettext: function() {
        return createGettext;
    },
    defineGettextConfig: function() {
        return defineGettextConfig;
    },
    useGettext: function() {
        return useGettext;
    }
...
var useGettext = function() {
    var gettext = (0, import_vue.inject)(GetTextSymbol, null);
    if (!gettext) {
...
// src/component.ts
var Component = (0, import_vue2.defineComponent)({
    ...
    setup: function setup(props, context) {
        ...
        var root = (0, import_vue2.ref)();
        var plugin = useGettext();
        var msgid = (0, import_vue2.ref)(null);
        (0, import_vue2.onMounted)(function() {
            if (!msgid.value && root.value) {
                msgid.value = root.value.innerHTML.trim();
            }
        });
        var translation = (0, import_vue2.computed)(function() {
            var _this;
            ...
            return interpolate_default(plugin)(translatedMsg, props.translateParams, void 0, (_this = (0, import_vue2.getCurrentInstance)()) === null || _this === void 0 ? void 0 : _this.parent);
        });
        return function() {
            if (!msgid.value) {
                return (0, import_vue2.h)(props.tag, {
                    ref: root
...
function directive(language) {
    ...
    return {
        beforeMount: function beforeMount(el, binding, vnode) {
            ...
            (0, import_vue3.watch)(language, function() {
...
function createGettext() {
    ...
    var translations = (0, import_vue4.ref)(normalizeTranslations(mergedOptions.translations));
    var gettext = (0, import_vue4.reactive)({
        available: mergedOptions.availableLanguages,
        muted: mergedOptions.mutedLanguages,
        silent: mergedOptions.silent,
        translations: (0, import_vue4.computed)({
            get: function() {
...
0 && (module.exports = {
    createGettext: createGettext,
    defineGettextConfig: defineGettextConfig,
    useGettext: useGettext
});
